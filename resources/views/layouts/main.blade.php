    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full px-3 py-12 overflow-y-auto bg-oren">
            <div class='flex justify-between mb-7 font-semibold text-white'>
                ...
                <x-coolicon-hamburger-md class="cursor-pointer w-6" />
            </div>
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="/product" class="flex items-center p-2 text-white rounded-lg hover:bg-[#f75c53] group">
                ...
                <li>
                    <a href="/profile" class="flex items-center p-2 text-white rounded-lg hover:bg-[#f75c53] group">
                        <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75" aria-hidden="true"
                ...
                @auth
                    <li>
                        <form action="/logout" method="post">
                            @csrf
                            <button type="submit"
                                class="flex items-center p-2 text-white rounded-lg hover:bg-[#f75c53] group w-full">
                                <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75" aria-hidden="true"
                ...
                @else
                    <li>
                        <a href="/auth" class="flex items-center p-2 text-white rounded-lg hover:bg-[#f75c53] group">
                            <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
